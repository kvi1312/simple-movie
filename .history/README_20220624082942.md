...
- React Paginate
- code splitting để tách cái chunk sau khi build, nhằm làm nhẹ dự án: sử dụng lazy import, suspense- thằng này cần phải bao bọc cả cái compo nào cần nó lazy load và  có props fallback
