...
const MoviePage = () => {
  ...
  useEffect(() => {
    if (filterDebounce) {
      setUrl(
        "https://api.themoviedb.org/3/search/movie/api_key=172c72b78f475e54c01895081cfafdea"
      );
    } else {
      setUrl(
        "https://api.themoviedb.org/3/movie/popular?api_key=172c72b78f475e54c01895081cfafdea&query=${filterDebounce}"
      );
    }
  }, [filterDebounce]);
